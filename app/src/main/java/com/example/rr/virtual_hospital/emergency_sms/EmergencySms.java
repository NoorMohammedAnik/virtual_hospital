package com.example.rr.virtual_hospital.emergency_sms;
...
//        getSupportActionBar().setTitle("Emergency SMS");
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String numberArray[]={number1,number2,number3};
...
//                }
                ...
                if (number1.isEmpty() || number1.length()<11 || number1.length()>11 ||number1.contains(" ") || number1.charAt(0)!='0' ||number1.charAt(1)!='1' ) {
                    etxtNumber1.setError("Please enter correct cell number !");
                    requestFocus(etxtNumber1);
                }



                else if (number2.isEmpty() || number2.length()<11 || number2.length()>11 || number2.contains(" ") || number2.charAt(0)!='0' ||number2.charAt(1)!='1' ) {
                    etxtNumber2.setError("Please enter correct cell number !");
                    requestFocus(etxtNumber2);
                }



                else if (number3.isEmpty() || number3.length()<11 ||number3.length()>11 || number3.contains(" ") || number3.charAt(0)!='0' ||number3.charAt(1)!='1' ) {
                    etxtNumber3.setError("Please enter correct cell number !");
                    requestFocus(etxtNumber3);
                }
                ...
                else if(msg.isEmpty())
                {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(EmergencySms.this);

                    new AlertDialog.Builder(EmergencySms.this)
                            .setMessage("Are you sure to send sms ?")
                            .setIcon(R.drawable.e_sms)
                            .setCancelable(false)

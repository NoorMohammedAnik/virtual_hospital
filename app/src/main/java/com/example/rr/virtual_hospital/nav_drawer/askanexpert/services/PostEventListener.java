...
public class PostEventListener extends IntentService {
    ...
    protected void onHandleIntent(final Intent intent) {
        ...
        myPostRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(servicePref.getString("userID",null));

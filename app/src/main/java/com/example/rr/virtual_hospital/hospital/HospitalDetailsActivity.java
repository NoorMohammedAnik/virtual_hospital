...
public class HospitalDetailsActivity extends AppCompatActivity {
  ...
  private   ImageView place_img;
   private TextView place_name,place_desc,place_location, place_division,place_contact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place_division = (TextView) findViewById(R.id.hosp_place_division);
        place_contact= (TextView) findViewById(R.id.hosp_place_contact);

        com.example.rr.virtual_hospital.info.model.Hospital getPlaceName = getIntent().getExtras().getParcelable("hospitalName");

        place_img.setImageResource(R.drawable.ic_hospital);

        if(!getPlaceName.getHospTitle().isEmpty()||getPlaceName.getHospTitle()!=null){
            place_name.setText(getPlaceName.getHospTitle());
        }else{
            place_name.setText("Not Available");
        }
        if(!getPlaceName.getHospDescription().isEmpty()){
            place_desc.setText(getPlaceName.getHospDescription());
        }else{
            place_desc.setText("Not Available");
        }
        if(!getPlaceName.getHospDivision().isEmpty()||getPlaceName.getHospDivision()!=null){
            place_division.setText(getPlaceName.getHospDivision());
        }else{
            place_division.setText("Not Available");
        }
        if(!getPlaceName.getHospLocation().isEmpty()||getPlaceName.getHospLocation()!=null){
            place_location.setText(getPlaceName.getHospLocation());
        }else{
            place_location.setText("Not Available");
        }
        if(!getPlaceName.getHospContact().isEmpty()||getPlaceName.getHospContact()!=null){
            place_contact.setText(getPlaceName.getHospContact());
        }else{
            place_contact.setText("Not Available");
        }

...
public class DoctorsDetailsActivity extends AppCompatActivity {
    ...
    private TextView place_name,place_desc,place_location,place_vistingtext,place_contactNumbertext,place_division;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place_division= (TextView) findViewById(R.id.doc_div);
        Doctors getDocName = getIntent().getExtras().getParcelable("docName");
        place_img.setImageResource(R.drawable.img_doctor);

        if(!getDocName.getDocName().isEmpty()){
            place_name.setText(getDocName.getDocName());
        }else{
            place_name.setText("Not Available");
        }
        if(!getDocName.getDocSpeciality().isEmpty()){
            place_desc.setText(getDocName.getDocSpeciality());
        }else{
            place_desc.setText("Not Available");
        }
        if(!getDocName.getDocDivision().isEmpty()||getDocName.getDocDivision()!=null){
            place_division.setText(getDocName.getDocDivision());
        }else{
            place_division.setText("Not Available");
        }
        if(!getDocName.getDocChamber().isEmpty()){
            place_location.setText(getDocName.getDocChamber());
        }else{
            place_location.setText("Not Available");
        }
        if(!getDocName.getDocVisitTime().isEmpty()){
            place_vistingtext.setText(getDocName.getDocVisitTime());
        }else{
            place_vistingtext.setText("Not Available");
        }if(!getDocName.getDocContact().isEmpty()){
            place_contactNumbertext.setText(getDocName.getDocContact());
        }else{
